...
import { View, Text, OpenData, Image, Button, Form, Switch, ScrollView, Label, Input, Textarea, Slider, Swiper, SwiperItem, Picker } from '@tarojs/components';
...
var AtButton = /** @class */ (function (_super) {
    ...
    AtButton.prototype.render = function () {
        ...
        return (React.createElement(View, { className: classnames(rootClassName, classObject, this.props.className), style: customStyle, onClick: this.onClick.bind(this) },
            ...
            isWEAPP && !disabled && (React.createElement(Form, { reportSubmit: true, onSubmit: this.onSumit.bind(this), onReset: this.onReset.bind(this) }, button)),
...
var AtSwipeAction = /** @class */ (function (_super) {
    ...
    AtSwipeAction.prototype.render = function () {
        ...
        return (React.createElement(View, { id: "swipeAction-" + componentId, className: rootClass, onTouchMove: this.handleTouchMove, onTouchEnd: this.handleTouchEnd, onTouchStart: this.handleTouchStart },
            ...
            Array.isArray(options) && options.length > 0 ? (React.createElement(AtSwipeActionOptions, { options: options, componentId: componentId, onQueryedDom: this.handleDomInfo }, options.map(function (item, key) { return (React.createElement(View, { key: item.text + "-" + key, style: item.style, onClick: _this.handleClick.bind(_this, item, key), className: classnames('at-swipe-action__option', item.className) },
...
var AtCalendarList = /** @class */ (function (_super) {
    ...
    AtCalendarList.prototype.render = function () {
        ...
        if (!list || list.length === 0)
            return null;
        return (React.createElement(View, { className: 'at-calendar__list flex' }, list.map(function (item, index) { return (React.createElement(View, { key: "list-item-" + index, onClick: _this.handleClick.bind(_this, item), onLongPress: _this.handleLongClick.bind(_this, item), className: classnames('flex__item', "flex__item--" + MAP[item.type], {
