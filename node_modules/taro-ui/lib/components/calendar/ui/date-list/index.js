...
export default class AtCalendarList extends React.Component {
    ...
    render() {
        ...
        if (!list || list.length === 0)
            return null;
        return (React.createElement(View, { className: 'at-calendar__list flex' }, list.map((item, index) => (React.createElement(View, { key: `list-item-${index}`, onClick: this.handleClick.bind(this, item), onLongPress: this.handleLongClick.bind(this, item), className: classnames('flex__item', `flex__item--${MAP[item.type]}`, {
